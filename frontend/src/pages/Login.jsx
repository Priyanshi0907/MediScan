...
import { ShieldPlus, Mail, Lock, Eye, EyeOff, AlertCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-sand-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          <h1 className="font-display font-extrabold text-2xl text-[#12241a] mb-1">Welcome back</h1>
          <p className="text-sm text-gray-500 mb-6">Log in to access your analysis dashboard.</p>
          ...
          <p className="text-sm text-gray-500 text-center mt-6">
            Don't have an account? <Link to="/signup" className="text-brand font-semibold">Sign up</Link>
          </p>
        </div>

        <p className="text-xs text-gray-400 text-center mt-6 max-w-sm mx-auto">
          MEDiScan provides AI-generated predictions for educational purposes only and is not a substitute for professional medical advice.
        </p>
      </div>
    </div>
  );
